...
VELA adopts useful plotting patterns from `Jinze-Lee/codex-skills-workbench` as adapters, not as separate default skills.
...
VELA also adopts useful figure/table prompt constraints from `Leey21/awesome-ai-research-writing`.
