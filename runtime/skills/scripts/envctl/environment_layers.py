...
GOVERNANCE_KERNEL_PATH = CATALOG_ROOT / "governance_kernel.json"
...
def validate_environment_layer_contract() -> dict[str, Any]:
    ...
    kernel = _safe_load(GOVERNANCE_KERNEL_PATH, "governance_kernel", errors)
...
def _collect_governance_contract_errors(
    ...
    expected_ref = "skills/catalog/governance_kernel.json"
    ...
    for item in [
        ...
        "workflow governance remains the core methodology and governance kernel",
