...
def build_evolution_intake_report(
    ...
    return {
        ...
        "next_actions": [
            ...
            "Run validate memory, validate governance, and validate stack before turning backlog items into source changes."
...
def _event_from_item(item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "required_gates": [
            ...
            "envctl validate governance",

            "validate_vela_runtime"
