...
def _run_stack_validator() -> dict:
    ...
    script = root / "validate_vela_runtime.py"
    ...
    if result.returncode != 0:
        ...
        return build_validator_result(
            ...
            errors=[f"validate_vela_runtime-exit:{result.returncode}"],
    ...
    try:
        ...
        return build_validator_result(
            ...
            errors=[f"validate_vela_runtime-invalid-json:{exc}"],
