...
from .commands import apply_profile, cnki_zotero, cybernetics, governance, evolution, init_project, memory, plan_team, route, validate
...
def build_parser() -> argparse.ArgumentParser:
    ...
    governance.add_parser(subparsers)
