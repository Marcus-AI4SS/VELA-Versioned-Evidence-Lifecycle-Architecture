...
def build_memory_reconciliation_report(*, probe_agentmemory: bool = False) -> dict[str, Any]:
    ...
    daily_reports = _report_inventory(OUTPUTS_ROOT / "reports" / "governance-daily")
    ...
    if not daily_reports["count"]:
        ...
        reconciliation.append("no governance daily report found; daily automation has no recent local evidence")
    ...
    return {
        ...
        "automation_reports": {
            ...
            "governance_daily_count": daily_reports["count"],

            "latest_governance_daily": daily_reports["latest"],
        ...
        "next_actions": [
            ...
            "Use project-retrospective-evolver for project lessons and vela-runtime-manager for governed source changes.",
...
def _default_score_components(
    ...
    *,
    ...
    elif privacy_scope == "local_private" and proposed_target in {"governance_kernel", "skill", "evolution_backlog"}:
