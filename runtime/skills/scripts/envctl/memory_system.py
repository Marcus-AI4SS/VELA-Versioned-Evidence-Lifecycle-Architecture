...
def build_memory_reconciliation_report() -> dict[str, Any]:
    policy = load_memory_policy()
    external_memory_service = _external_memory_service_status()
...
def _external_memory_service_status() -> dict[str, Any]:
    return {
        "configured": False,
        "checked": False,
        "healthy": None,
        "summary": "VELA does not configure, install, or prestart an external memory service by default.",
    }
