...
class ExternalAdoptionReadinessTests(unittest.TestCase):
    ...
    def test_external_adoption_readiness_validator_passes(self) -> None:
        ...
        self.assertEqual(probes["colbymchenry/codegraph"]["kind"], "installed_runtime")
        self.assertEqual(probes["opendataloader-project/opendataloader-pdf"]["kind"], "optional_backend")
