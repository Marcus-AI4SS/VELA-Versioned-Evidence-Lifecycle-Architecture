...
class EnvironmentLayerContractTests(unittest.TestCase):
    ...
    def test_local_memory_and_codegraph_are_not_rule_sources(self) -> None:
        payload = load_json(ROOT / "catalog" / "environment_layer_contract.json")
        ...
        self.assertIn("runtime memory candidates", assertions)
        ...
        self.assertEqual(adapter["selected_adapter"], "local_contract_only")
