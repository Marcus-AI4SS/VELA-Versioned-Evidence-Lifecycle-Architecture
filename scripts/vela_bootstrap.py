...
def bootstrap_tools(
    ...
    *,
    ...
    next_action = (
        ...
        "Run install.ps1 -BootstrapTools, then restart the terminal and run vela runtime check --include all."
        if not required_ready
        else "Run vela runtime check --include all after installing the VELA-owned runtime layer."
    )
