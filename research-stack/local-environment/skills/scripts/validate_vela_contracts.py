...
SCHEMA_EXPECTATIONS = {
    ...
    "helm_app_command": {
        ...
        "id": "https://research-environment-local/schemas/helm.app.command.v1.schema.json",
        "schema_version": "helm.app.command.v1",
    },
    "research_team_playbook": {
        "path": SCHEMAS_ROOT / "research_team_playbook.schema.json",
        "id": "https://research-environment-local/schemas/research_team_playbook.schema.json",
    ...
    "project_initializer_manifest": {
        ...
        "id": "https://research-environment-local/schemas/project_initializer_manifest.schema.json",
        "schema_version": "project_initializer_manifest.v1",
    },
    "clarification_card": {
        "path": SCHEMAS_ROOT / "clarification_card.schema.json",
        "id": "https://research-environment-local/schemas/clarification_card.schema.json",
        "schema_version": None,
    },
    "team_plan_result": {
        "path": SCHEMAS_ROOT / "team_plan_result.schema.json",
        "id": "https://research-environment-local/schemas/team_plan_result.schema.json",
        "schema_version": None,
    },
    "validator_result": {
        "path": SCHEMAS_ROOT / "validator_result.schema.json",
        "id": "https://research-environment-local/schemas/validator_result.schema.json",
        "schema_version": None,
    },
    "helm_snapshot_manifest": {
        "path": SCHEMAS_ROOT / "helm_snapshot_manifest.schema.json",
        "id": "https://research-environment-local/schemas/helm_snapshot_manifest.schema.json",
