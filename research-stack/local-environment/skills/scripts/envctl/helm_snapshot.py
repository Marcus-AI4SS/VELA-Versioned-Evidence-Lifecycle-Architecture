...
PUBLIC_CATALOG_FILES = [
    ...
    "cybernetic_source_rule_crosswalk.json",
...
BLOCKED_PATTERNS = {
    "c-drive-user-path": re.compile(r"C:(?:\\|/)Users(?:\\|/)17666", re.IGNORECASE),
    "d-drive-private-root": re.compile(r"D:(?:\\|/)AI environment-GITHUB", re.IGNORECASE),
    ...
    "manager-app-output": re.compile(r"skills/outputs/manager-app|manager-app", re.IGNORECASE),
}
