...
- The user says `降 AI 率`, `降 AIGC`, `去 AI 味`, `不像 AI 写的`, `humanize`, `deslop`, `avoid AI writing`, `去翻译腔`, or `学术去模板化`.
...
- uniform sentence rhythm, rule-of-three lists, synonym cycling, false ranges, and decorative contrast.
